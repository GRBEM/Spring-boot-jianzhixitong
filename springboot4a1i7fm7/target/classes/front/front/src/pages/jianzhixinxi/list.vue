...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"1"}'>
      ...
      <el-form-item :style='{"margin":"0 10px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>薪资待遇：</div>
        <el-input v-model="formSearch.xinzidaiyu" placeholder="薪资待遇" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#000","display":"inline-block"}'>企业名称：</div>
	  ...
	  <el-button v-if="btnAuth('jianzhixinxi','新增')" :style='{"cursor":"pointer","border":"2px solid #FFC174","padding":"0px 15px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"5px","background":"#0D5451","width":"auto","fontSize":"14px","lineHeight":"38px","height":"42px"}' type="primary" @click="add('/index/jianzhixinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"calc(100% - 400px)","margin":"0 0 10px","background":"#fff","flex":"1","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"border":"5px solid #FFC174","padding":"10px 0","borderRadius":"10px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
			<div :style='{"border":"5px solid #FFC174","padding":"10px","margin":"0 15px 30px","borderRadius":"30px","color":"#000","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(25% - 30px)","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<img @click.stop="imgPreView(item.bangonghuanjing)" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"275px","order":"1"}' v-if="item.bangonghuanjing && item.bangonghuanjing.substr(0,4)=='http'" :src="item.bangonghuanjing.split(',')[0]" class="image" />
				<img @click.stop="imgPreView(baseUrl + (item.bangonghuanjing?item.bangonghuanjing.split(',')[0]:''))" :style='{"width":"100%","objectFit":"cover","borderRadius":"30px","display":"block","height":"275px","order":"1"}' v-else :src="baseUrl + (item.bangonghuanjing?item.bangonghuanjing.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"0 10px","color":"inherit","textAlign":"center","width":"100%","lineHeight":"2","fontSize":"16px","fontWeight":"bold","order":"3"}' class="name ">薪资待遇:{{item.xinzidaiyu}}</div>
				<div :style='{"padding":"0 10px","color":"inherit","textAlign":"center","width":"100%","lineHeight":"2","fontSize":"16px","fontWeight":"bold","order":"3"}' class="name ">企业名称:{{item.qiyemingcheng}}</div>
				...
				<div :style='{"padding":"0 5px","display":"inline-block","order":"7"}'>
				  ...
				  <span class="text" :style='{"color":"inherit","lineHeight":"1.5","fontSize":"14px"}'>{{item.qiyemingcheng}}</span>
				</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      getFenlei() {
		this.$http.get('jianzhileixing/list',{}).then(res => {
		  if (res.data.code == 0) {
		    this.fenlei = res.data.data.list
		  }
		});
		this.feileiColumn = 'jianzhileixing'
      },
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.xinzidaiyu != '') searchWhere.xinzidaiyu = '%' + this.formSearch.xinzidaiyu + '%';
        if (this.formSearch.qiyemingcheng != '') searchWhere.qiyemingcheng = '%' + this.formSearch.qiyemingcheng + '%';
        if (this.curFenlei != '全部') searchWhere.jianzhileixing = this.curFenlei;
