	...
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#666","borderRadius":"0 0 10px 10px","background":"#fff","width":"calc(100% - 60px)","fontSize":"16px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info'&& !ro.jianliwenjian" label="简历文件" prop="jianliwenjian">
					<file-upload
						tip="点击上传简历文件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.jianliwenjian" label="简历文件" prop="jianliwenjian">
					<el-button :style='{"border":"1px solid rgba(19,161,230,.2)","cursor":"pointer","padding":"0 30px","margin":"0 20px 0 0","outline":"none","color":"inherit","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"36px","fontSize":"16px","height":"44px"}' type="text" size="small" @click="download($base.url+ruleForm.jianliwenjian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="!ruleForm.jianliwenjian" label="简历文件" prop="jianliwenjian">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="date" v-if="type!='info'" label="申请日期" prop="shenqingriqi">
					<el-date-picker
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.shenqingriqi" label="申请日期" prop="shenqingriqi">
					<el-input v-model="ruleForm.shenqingriqi" placeholder="申请日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="申请信息" prop="shenqingxinxi">
					<el-input v-model="ruleForm.shenqingxinxi" placeholder="申请信息" clearable  :readonly="ro.shenqingxinxi"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="申请信息" prop="shenqingxinxi">
					<el-input v-model="ruleForm.shenqingxinxi" placeholder="申请信息" readonly></el-input>
				</el-form-item>
