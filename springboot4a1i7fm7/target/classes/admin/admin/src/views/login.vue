  ...
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://localhost:8080/springboot4a1i7fm7/upload/bg.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #eee","padding":"20px 20px 120px 20px","boxShadow":"0 1px 9px rgba(64, 158, 255, .6)","margin":"0","borderRadius":"0px","textAlign":"center","background":"rgba(255,255,255,1)","clipPath":"polygon(0% 0%, 100% 0%, 100% 85%, 75% 85%, 75% 100%, 50% 85%, 0 85%)","width":"750px","fontSize":"16px","height":"auto"}'>
        <div v-if="true" :style='{"padding":"10px","margin":"0px auto 30px","color":"rgba(55,55,55,1)","textAlign":"center","background":"linear-gradient(90deg, rgba(22,136,199,1) 0%, rgba(54,221,227,1) 50%, rgba(140,179,122,1) 100%)","-webkitTextFillColor":"transparent","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"28px","fontWeight":"600","-webkitBackgroundClip":"text"}' class="title-container">大学生兼职平台登录</div>
