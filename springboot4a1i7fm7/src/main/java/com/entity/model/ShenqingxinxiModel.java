...
public class ShenqingxinxiModel  implements Serializable {
	...
	public void setShenqingxinxi(String shenqingxinxi) {
		this.shenqingxinxi = shenqingxinxi;
	}
	
	/**
	 * 获取：申请信息
	 */
	public String getShenqingxinxi() {
		return shenqingxinxi;
	}
